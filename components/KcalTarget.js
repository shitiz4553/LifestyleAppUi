...
function KcalTarget({modalVisible,setModalVisible,modalTitle,modalMessage,color}){
    return (
      <Modal
        animationType="slide"
        transparent={true}
          ...
          <View style={styles.modalView}>
            ...
            >
              ...
              <View style={Theme.align}>
                ...
                <View style={styles.input}>
                    <Text style={{fontFamily:Theme.MulishBold}}>Calories</Text>
                </View>
              </View>
            </View>
            <View
